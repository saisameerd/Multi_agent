INTENT_DETECTION_INSTRUCTION_STR = """
    ...
    Analyze the user's natural language query and classify it into one of two categories:
    ...
    2. **nl2sql** - If the user is asking for:
       - Regular database queries
       - Data analysis questions
       - Business intelligence queries
       - Any other data retrieval or analysis not related to tone/sentiment
    
    Look for keywords like: "tone", "sentiment", "emotion", "mood", "analysis" in the context of conversations or chat data.
    
    Output only one word: either "tone_analysis" or "nl2sql"
""" 